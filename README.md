...
```bash
git clone https://https://github.com/srivardhan121/face-recognition-attendance-management-system
...
For any questions or issues, feel free to contact **[srivardhan121@gmail.com]**.
