...
def manually_fill():
    ...
    sb.geometry('580x320')
    sb.configure(background='skyblue')
    ...
    def err_screen_for_subject():
        ...
        ec.title('Warning!!')
        ec.configure(background='lightcoral')
    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='root123', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            MFW.configure(background='skyblue')
            ...
            def err_screen1():
                ...
                errsc2.configure(background='skyblue')
                Label(errsc2, text='Please enter Student & Enrollment!!!', fg='skyblue', bg='white',
                      font=('times', 16, ' bold ')).pack()
                Button(errsc2, text='OK', command=del_errsc2, fg="skyblue", bg="lawn green", width=9, height=1,
            ...
            ENR = tk.Label(MFW, text="Enter Enrollment", width=15, height=2, fg="skyblue", bg="grey",
                           font=('times', 15))
            ENR.place(x=30, y=100)

            STU_NAME = tk.Label(MFW, text="Enter Student name", width=15, height=2, fg="skyblue", bg="grey",
                                font=('times', 15))
            ...
            def create_csv():
                ...
                csv_name = 'D:/internship/123/Attendance Management System using Face Recognition/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:\internship\123\Attendance Management System using Face Recognition\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='root123', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='grey80')
                cs = 'D:/internship/123/Attendance Management System using Face Recognition/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"D:\internship\123\Attendance Management System using Face Recognition\Attendance-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'root':
            if password == 'root123':
                ...
                cs = 'D:/internship/123/Attendance Management System using Face Recognition/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
